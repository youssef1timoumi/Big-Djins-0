  ...
  items: [
    {
      ...
      description: 'At BIG DJINS:0, quality is a commitment. We enforce strict controls throughout production and prioritize our employees\' well-being — both of which shine through in our final products.',
    },
    {
...
export const contactAbout: ContactProps = {
  ...
  items: [
    {
      title: 'Our Address',
      description: ['Cité El , Cité el Manar', 'Jammel, Sahel 5020, TN'],
      icon: IconMapPin,
    },
    {
      title: 'Contact',
